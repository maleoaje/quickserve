...
class SearchPageDelivery extends StatefulWidget {
  const SearchPageDelivery({Key? key}) : super(key: key);

  @override
  _SearchPageDeliveryState createState() => _SearchPageDeliveryState();
}

class _SearchPageDeliveryState extends State<SearchPageDelivery> {
