...
class FavoritesPageDelivery extends StatefulWidget {
  const FavoritesPageDelivery({Key? key}) : super(key: key);

  @override
  _FavoritesPageDeliveryState createState() => _FavoritesPageDeliveryState();
}

class _FavoritesPageDeliveryState extends State<FavoritesPageDelivery> {
