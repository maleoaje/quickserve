...
class AccountPageRestaurants extends StatefulWidget {
  const AccountPageRestaurants({Key? key}) : super(key: key);

  @override
  _AccountPageRestaurantsState createState() => _AccountPageRestaurantsState();
}

class _AccountPageRestaurantsState extends State<AccountPageRestaurants> {
  @override
    ...
    showModalBottomSheet(
      ...
      builder: (context) {
        return SizedBox(
          ...
          child: _buildLogOutInput(),
        );
      },
    );
  }

  Widget _buildLogOutInput() {
    return Column(
      children: [
        const SizedBox(
          height: 30,
